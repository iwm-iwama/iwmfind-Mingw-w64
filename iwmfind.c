...
print_help()
{
	...
	P1(
		...
		IESC_STR1
		"\033[14G"	"abs(X)"	"\033[44G"	"changes()"	"\033[74G"	"char(X1,X2,...,XN)"	"\n"
		"\033[14G"	"coalesce(X,Y,...)"	"\033[44G"	"concat(X,...)"	"\033[74G"	"concat_ws(SEP,X,...)"	"\n"
		"\033[14G"	"format(FORMAT,...)"	"\033[44G"	"glob(X,Y)"	"\033[74G"	"hex(X)"	"\n"
		"\033[14G"	"if(X,Y)"	"\033[44G"	"if(X,Y,Z)"	"\033[74G"	"ifnull(X,Y)"	"\n"
		"\033[14G"	"iif(X,Y)"	"\033[44G"	"iif(X,Y,Z)"	"\033[74G"	"instr(X,Y)"	"\n"
		...
		"\033[14G"	"ltrim(X)"	"\033[44G"	"ltrim(X,Y)"	"\033[74G"	"max(X,Y,...)"	"\n"
		"\033[14G"	"min(X,Y,...)"	"\033[44G"	"nullif(X,Y)"	"\033[74G"	"octet_length(X)"	"\n"
		"\033[14G"	"printf(FORMAT,...)"	"\033[44G"	"quote(X)"	"\033[74G"	"random()"	"\n"
		"\033[14G"	"randomblob(N)"	"\033[44G"	"replace(X,Y,Z)"	"\033[74G"	"round(X)"	"\n"
		"\033[14G"	"round(X,Y)"	"\033[44G"	"rtrim(X)"	"\033[74G"	"rtrim(X,Y)"	"\n"
		"\033[14G"	"sign(X)"	"\033[44G"	"soundex(X)"	"\033[74G"	"sqlite_compileoption_get(N)"	"\n"
		"\033[14G"	"sqlite_compileoption_used(X)"	"\033[44G"	"sqlite_offset(X)"	"\033[74G"	"sqlite_source_id()"	"\n"
		"\033[14G"	"sqlite_version()"	"\033[44G"	"substr(X,Y)"	"\033[74G"	"substr(X,Y,Z)"	"\n"
		"\033[14G"	"substring(X,Y)"	"\033[44G"	"substring(X,Y,Z)"	"\033[74G"	"total_changes()"	"\n"
		"\033[14G"	"trim(X)"	"\033[44G"	"trim(X,Y)"	"\033[74G"	"typeof(X)"	"\n"
		"\033[14G"	"unhex(X)"	"\033[44G"	"unhex(X,Y)"	"\033[74G"	"unicode(X)"	"\n"
		"\033[14G"	"unlikely(X)"	"\033[44G"	"upper(X)"	"\033[74G"	"zeroblob(N)"	"\n"
		"\033[14G"	IESC_LBL2	"(参考) http://www.sqlite.org/lang_corefunc.html"	"\n"
		"\n"
